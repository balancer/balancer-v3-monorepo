...
Solidity 0.8.20 or higher is required to support the Dencun release with transient storage. We strongly recommend using the latest released version of the Solidity compiler (at least 0.8.21), to incorporate all the latest bug fixes.
