...
import { SwapStatefulTest } from "@balancer-labs/v3-vault/test/foundry/stateful/SwapStateful.t.sol";

import { StablePoolFactory } from "../../../contracts/StablePoolFactory.sol";
import { StablePool } from "../../../contracts/StablePool.sol";
import { StablePoolContractsDeployer } from "../utils/StablePoolContractsDeployer.sol";

contract SwapStatefulStableTest is SwapStatefulTest, StablePoolContractsDeployer {
    ...
    /// @notice Overrides BaseVaultTest _createPool(). This pool is used by SwapStatefulTest tests.
