...
contract BufferSwapTest is BaseVaultTest {
    ...
    function testBoostedPoolSwapExactIn() public {
        ...
        vm.prank(alice);
        snapStart('testBoostedPoolSwapExactIn');
    ...
    function testBoostedPoolSwapExactOut() public {
        ...
        vm.prank(alice);
        snapStart('testBoostedPoolSwapExactOut');
    ...
    function testBoostedPoolSwapSimpleRebalance() public {
        ...
        vm.prank(alice);
        snapStart('testBoostedPoolSwapSimpleRebalance');
        (uint256[] memory pathAmountsOut, address[] memory tokensOut, uint256[] memory amountsOut) = batchRouter
            .swapExactIn(paths, MAX_UINT256, false, bytes(""));
        snapEnd();
    ...
    function testBoostedPoolSwapMoreThan50pRebalance() public {
        ...
        vm.prank(alice);
        snapStart('testBoostedPoolSwapMoreThan50pRebalance');
        (uint256[] memory pathAmountsOut, address[] memory tokensOut, uint256[] memory amountsOut) = batchRouter
            .swapExactIn(paths, MAX_UINT256, false, bytes(""));
        snapEnd();
    ...
    function _buildExactInPaths(
        ...
        steps[0] = IBatchRouter.SwapPathStep({ pool: waDAIBufferPool, tokenOut: waDAI, isBuffer: false });
        steps[1] = IBatchRouter.SwapPathStep({ pool: boostedPool, tokenOut: waUSDC, isBuffer: false });
        steps[2] = IBatchRouter.SwapPathStep({ pool: waUSDCBufferPool, tokenOut: usdc, isBuffer: false });
    ...
    function _buildExactOutPaths(
        ...
        // NOTE: Set isBuffer as false so buffer pools are used, instead of internal buffers
        steps[0] = IBatchRouter.SwapPathStep({ pool: waDAIBufferPool, tokenOut: waDAI, isBuffer: false });
        steps[1] = IBatchRouter.SwapPathStep({ pool: boostedPool, tokenOut: waUSDC, isBuffer: false });
        steps[2] = IBatchRouter.SwapPathStep({ pool: waUSDCBufferPool, tokenOut: usdc, isBuffer: false });
