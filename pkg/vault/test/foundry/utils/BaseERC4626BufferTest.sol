...
import { TokenConfig, TokenType } from "@balancer-labs/v3-interfaces/contracts/solidity-utils/BasePoolTypes.sol";
...
abstract contract BaseERC4626BufferTest is BaseVaultTest {
    ...
    function _setupWrappedTokens() private {
        ...
        waUSDC.inflateUnderlyingOrWrapped(4 * erc4626PoolInitialAmount, 0);
    }
}
