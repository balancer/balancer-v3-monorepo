...
contract CompositeLiquidityRouterERC4626PoolTest is BaseERC4626BufferTest {
    ...
    function testAddLiquidityUnbalancedToERC4626PoolWithEth__Fuzz(
        ...
        vm.prank(alice);
        uint256 bptOut = CompositeLiquidityRouter(payable(address(clrRouter))).addLiquidityUnbalancedToERC4626Pool{
    ...
    function testAddLiquidityUnbalancedToERC4626PoolWhenStaticCall() public checkBuffersWhenStaticCall(alice) {
        ...
        _prankStaticCall();
        clrRouter.queryAddLiquidityUnbalancedToERC4626Pool(
            pool,
            wrapUnderlying,
            exactUnderlyingAmountsIn,
            address(this),
    ...
    function testQueryAddLiquidityUnbalancedToERC4626Pool() public {
        ...
        _prankStaticCall();
        uint256 queryBptAmountOut = clrRouter.queryAddLiquidityUnbalancedToERC4626Pool(
            pool,
            wrapUnderlying,
            exactUnderlyingAmountsIn,
            address(this),
        ...
        vm.startPrank(alice);
        uint256 actualBptAmountOut = _addLiquidityUnbalancedToERC4626Pool(
            pool,
            wrapUnderlying,
            exactUnderlyingAmountsIn,
            1,
    ...
    function testAddLiquidityProportionalToERC4626PoolWithEth__Fuzz(
        ...
        vm.prank(alice);
        uint256[] memory actualUnderlyingAmountsIn = CompositeLiquidityRouter(payable(address(clrRouter)))
            .addLiquidityProportionalToERC4626Pool{ value: operationAmount + (forceEthLeftover ? 1e18 : 0) }(
            pool,
            wrapUnderlying,
            maxAmountsIn,
            exactBptAmountOut,
    ...
    function testAddLiquidityProportionalToERC4626PoolWhenStaticCall() public checkBuffersWhenStaticCall(alice) {
        ...
        _prankStaticCall();
        clrRouter.queryAddLiquidityProportionalToERC4626Pool(
            pool,
            wrapUnderlying,
            operationAmount,
            address(this),
    ...
    function testQueryAddLiquidityProportionalToERC4626Pool() public {
        ...
        uint256 snapshotId = vm.snapshotState();
        _prankStaticCall();
        uint256[] memory queryUnderlyingAmountsIn = clrRouter.queryAddLiquidityProportionalToERC4626Pool(
            pool,
            wrapUnderlying,
            exactBptAmountOut,
            address(this),
    ...
    function testRemoveLiquidityProportionalFromERC4626PoolWhenStaticCall() public checkBuffersWhenStaticCall(bob) {
        ...
        _prankStaticCall();
        clrRouter.queryRemoveLiquidityProportionalFromERC4626Pool(
            pool,
            unwrapWrapped,
            exactBptAmountIn,
            address(this),
