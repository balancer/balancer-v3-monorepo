...
contract PoolConfigConstTest is BaseBitsConfigTest {
    function testOffsets() public {
        ...
        _checkBitsUsedOnce(PoolConfigConst.ANY_INITIALIZE_HOOK_ENABLED_OFFSET);
        _checkBitsUsedOnce(PoolConfigConst.ANY_SWAP_HOOK_ENABLED_OFFSET);
        _checkBitsUsedOnce(PoolConfigConst.ANY_ADD_LIQUIDITY_HOOK_ENABLED_OFFSET);
        _checkBitsUsedOnce(PoolConfigConst.ANY_REMOVE_LIQUIDITY_HOOK_ENABLED_OFFSET);
