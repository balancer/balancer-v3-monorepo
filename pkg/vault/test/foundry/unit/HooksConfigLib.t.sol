...
contract HooksConfigLibTest is Test {
    ...
    function testIsAnyInitializeHookEnabled() public {
        ...
        config = PoolConfigBits.wrap(
            PoolConfigBits.unwrap(config).insertBool(true, PoolConfigConst.ANY_INITIALIZE_HOOK_ENABLED_OFFSET)
        );
    ...
    function testIsAnySwapHookEnabled() public {
        PoolConfigBits config;
        config = PoolConfigBits.wrap(
            PoolConfigBits.unwrap(config).insertBool(true, PoolConfigConst.ANY_SWAP_HOOK_ENABLED_OFFSET)
        );
    ...
    function testIsAnyAddLiquidityHookEnabled() public {
        PoolConfigBits config;
        config = PoolConfigBits.wrap(
            PoolConfigBits.unwrap(config).insertBool(true, PoolConfigConst.ANY_ADD_LIQUIDITY_HOOK_ENABLED_OFFSET)
        );
    ...
    function testIsAnyRemoveLiquidityHookEnabled() public {
        PoolConfigBits config;
        config = PoolConfigBits.wrap(
            PoolConfigBits.unwrap(config).insertBool(true, PoolConfigConst.ANY_REMOVE_LIQUIDITY_HOOK_ENABLED_OFFSET)
        );
