...
contract ERC4626RebalanceSmallRateValidation is BaseVaultTest {
    ...
    function testSmallRateWithMoreUnderlying__Fuzz__Fork(uint256 assetsToTransfer) public {
    ...
    function testSmallRateWithMoreWrapped__Fuzz__Fork(uint256 assetsToTransfer) public {
        uint8 decimals = waDAI.decimals();
