...
contract BufferInsideVaultTest is BaseVaultTest {
    ...
    function initializeBuffers() private {
        ...
        router.addLiquidityBuffer(waDAI, defaultAmount, defaultAmount);
        waUSDC.approve(address(vault), MAX_UINT256);
        router.addLiquidityBuffer(waUSDC, defaultAmount, defaultAmount);
        vm.stopPrank();
    }
    ...
    function testSwapPreconditions() public {
        ...
        // TODO check buffer liquidity lp should have all the buffer BPT.
        //        assertEq(
