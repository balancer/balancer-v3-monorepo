...
import { SwapParams } from "@balancer-labs/v3-interfaces/contracts/vault/IVaultMain.sol";

import { BalancerPoolToken } from "./BalancerPoolToken.sol";

abstract contract BaseDynamicFeePool is IBasePool, IBaseDynamicFeePool, BalancerPoolToken {
    function computeFee(PoolData memory poolData, SwapParams memory params) public view virtual returns (uint256);
