    ...
    *******************************************************************************/
        ...
        )
    {
        ...
        if (params.kind == AddLiquidityKind.PROPORTIONAL) {
            ...
            poolData.poolConfig.requireSupportsUnbalancedLiquidity();
            ...
            poolData.poolConfig.requireSupportsAddLiquidityCustom();
        ...
        )
    {
        ...
        if (params.kind == RemoveLiquidityKind.PROPORTIONAL) {
            ...
            poolData.poolConfig.requireSupportsRemoveLiquidityCustom();
