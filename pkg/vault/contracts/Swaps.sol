...
import "@balancer-labs/v3-interfaces/contracts/vault/IPoolSwapStructs.sol";
...
import "@balancer-labs/v3-solidity-utils/contracts/openzeppelin/EnumerableSet.sol";
...
import "@balancer-labs/v3-solidity-utils/contracts/openzeppelin/SafeCast.sol";
...
abstract contract Swaps is ReentrancyGuard, PoolBalances {
     ...
     */
    function _tokenGiven(SwapKind kind, IERC20 tokenIn, IERC20 tokenOut) private pure returns (IERC20) {
     ...
     */
    function _tokenCalculated(SwapKind kind, IERC20 tokenIn, IERC20 tokenOut) private pure returns (IERC20) {
