...
import { TokenInfoLib, TokenInfoContract } from "./TokenInfoLib.sol";
...
library PoolDataLib {
    ...
    function load(
        ...
        (IERC20[] memory tokens, TokenInfo[] memory poolTokenInfo) = tokenInfoContract.getTokensAndTokenInfo();
