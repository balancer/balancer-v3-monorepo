...
library PoolConfigConst {
    ...
    uint8 public constant ENABLE_HOOK_ADJUSTED_AMOUNTS_SWAP_OFFSET = ENABLE_HOOK_ADJUSTED_AMOUNTS_REMOVE_OFFSET + 1;
    uint8 public constant AFTER_INITIALIZE_OFFSET = ENABLE_HOOK_ADJUSTED_AMOUNTS_SWAP_OFFSET + 1;
