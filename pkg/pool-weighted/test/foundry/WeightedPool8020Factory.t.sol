...
contract WeightedPool8020FactoryTest is Test {
    ...
    function testPoolCreation__Fuzz(bytes32 salt) public {
        ...
        WeightedPool pool = WeightedPool(factory.create("Balancer 80/20 Pool", "Pool8020", tokens, 0, bytes32(0)));
    ...
    function testInvalidPoolMinTokens() public {
        ...
        factory.create("Balancer 80/20 Pool", "Pool8020", tokens, 0, bytes32(0));
    }
    ...
    function testPoolSalt__Fuzz(bytes32 salt) public {
        ...
        WeightedPool secondPool = WeightedPool(factory.create("Balancer 80/20 Pool", "Pool8020", tokens, 0, salt));
    ...
    function testPoolSender__Fuzz(bytes32 salt) public {
        ...
        vm.prank(alice);
        WeightedPool pool = WeightedPool(factory.create("Balancer 80/20 Pool", "Pool8020", tokens, 0, salt));
    ...
    function testPoolCrossChainProtection__Fuzz(bytes32 salt, uint16 chainId) public {
        ...
        vm.prank(alice);
        WeightedPool poolMainnet = WeightedPool(factory.create("Balancer 80/20 Pool", "Pool8020", tokens, 0, salt));

        vm.chainId(chainId);

        vm.prank(alice);
        WeightedPool poolL2 = WeightedPool(factory.create("Balancer 80/20 Pool", "Pool8020", tokens, 0, salt));
