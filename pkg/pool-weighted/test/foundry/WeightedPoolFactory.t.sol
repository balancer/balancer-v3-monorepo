...
contract WeightedPoolFactoryTest is BaseVaultTest {
    ...
    function testCreatePoolWithoutDonation() public {
        ...
        router.addLiquidityCustom(weightedPool, [poolInitAmount, poolInitAmount].toMemoryArray(), 0, false, bytes(""));
    }
    ...
    function testCreatePoolWithDonation() public {
        ...
        vm.prank(bob);
        router.addLiquidityCustom(weightedPool, [amountToDonate, amountToDonate].toMemoryArray(), 0, false, bytes(""));
