  ...
  describe('initialization', () => {
    ...
    context('initialized', () => {
      sharedBeforeEach('initialize pool', async () => {
        ...
        expect(await router.connect(alice).initialize(pool, INITIAL_BALANCES, FP_ZERO, false, '0x'))
      ...
      it('cannot be initialized twice', async () => {
        await expect(router.connect(alice).initialize(pool, INITIAL_BALANCES, FP_ZERO, false, '0x'))
